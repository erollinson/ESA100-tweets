---
title: "A summary of the tweets generated at the 2015 Ecological Society of America meeting (#ESA100)"
author: EJ Rollinson
output:
   html_document:
     toc: true
...
This document was generated using RMarkdown, and the source is available on GitHub at: https://github.com/erollinson(ESA100-tweets (forked from https://github.com/fmichonneau/evol2015-tweets).

Tweets using the hashtag #ESA100 were aggregated from Twitter using the R package twitteR and the Twitter API.  The aggregated tweets are [available on Figshare] (http://dx.doi.org/10.6084/m9.figshare.1512350).
